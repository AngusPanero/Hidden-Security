...
const CursosParams = () => {
    ...
    const sectors = [
        { 
            id: "01", 
            title: "SOC Operations & Defence", 
            desc: "Monitoreo de infraestructuras críticas en tiempo real bajo protocolos de alta fidelidad. Desarrollamos arquitecturas de detección inmersiva y respuesta proactiva con visión realista para perímetros corporativos. Diseñamos centros de operaciones que permiten una gestión de amenazas fluida y una resiliencia profunda, rompiendo los límites de la defensa tradicional de redes.", 
            img: img1, 
            code: "SEC_OPS_01" 
        },
        { 
            ...
            <div className="h-tactic-horizon">
                <div className="h-tactic-wrapper">
                    {sectors.map((p, i) => (
                        <motion.section
                            key={p.id}
                            className={`h-tactic-strip ${expanded === i ? 'is-active' : ''}`}
                            onClick={() => handleToggle(i)}
                            onMouseEnter={() => !isMobile && setExpanded(i)}
                            animate={{ 
                                width: isMobile ? "100%" : (expanded === i ? "55%" : "9%"),
                                height: isMobile ? (expanded === i ? "450px" : "70px") : "85%"
                            }}
                        ...
                        >
                            <div className="h-strip-bg">
                                <motion.img 
                                    ...
                                    alt={p.title}
                                    animate={{ 
                                        scale: expanded === i ? 1.05 : 1.3,
                                        filter: expanded === i ? "grayscale(0) brightness(0.5)" : "grayscale(1) brightness(0.15)"
                                    }}
                                />
                                ...
                                {expanded === i && (
                                    ...
                                    >
                                        <div className="h-expanded-header">
                                            <span className="h-label-mono">[{p.code}]</span>
